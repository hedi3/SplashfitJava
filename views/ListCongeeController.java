...
inputuser.setValue(  tableview.getSelectionModel().getSelectedItem().getEmployee());
  ...
  private void printPDF() throws FileNotFoundException, DocumentException, IOException {
        ...
        PdfWriter.getInstance(d, new FileOutputStream("C:\\Users\\hedia\\OneDrive\\Desktop\\pidev PDF\\ListCongee.pdf"));
        d.open();
     ...
     //   pTable.addCell("NomEvent");
        ...
        d.close();
        Desktop.getDesktop().open(new File("C:\\Users\\hedia\\OneDrive\\Desktop\\pidev PDF\\ListCongee.pdf"));
