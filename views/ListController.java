  ...
  public void resetTableData() throws SQLDataException, SQLException {
    ...
    private void Ajouter(ActionEvent event) throws IOException {
       ...
       private void printPDF() throws FileNotFoundException, DocumentException, IOException {
        ...
        PdfWriter.getInstance(d, new FileOutputStream("C:\\Users\\hedia\\OneDrive\\Desktop\\pidev PDF\\UserList.pdf"));
        d.open();
     ...
     //   pTable.addCell("NomEvent");
        ...
        d.close();
        Desktop.getDesktop().open(new File("C:\\Users\\hedia\\OneDrive\\Desktop\\pidev PDF\\UserList.pdf"));
