...
public class MenuFXMLController implements Initializable {
    ...
    private Button StoreNavigationButton;
     ...
     @FXML
    private Button OffreNavigationButton;
     
     @FXML
     private Button AbonnementNavigationButton;
     
     @FXML
    private Button ReclamationNavigationButton;
     
     @FXML
     private Button MaterielNavigationButton;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        MaterielNavigationButton.setOnAction((t)->{
            navigate("Materiel",true);
        });
        ReclamationNavigationButton.setOnAction((t)->{
            navigate("Reclamation",true);
        });
        AbonnementNavigationButton.setOnAction((t)->{
            navigate("Abonnement",true);
        });
        OffreNavigationButton.setOnAction((t)->{
            navigate("Offre",true);
        });
